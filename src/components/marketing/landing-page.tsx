...
const looks = [
  ...
  { image: "/image/perfect_styling1.webp", title: "A little more you", text: "Thoughtful recommendations that sharpen your instincts, not replace them." },
  { image: "/image/your_style.webp", title: "Your style, decoded", text: "A visual language built from the details that make you, you." },
];
