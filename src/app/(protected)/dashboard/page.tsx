    ...
    <div className="min-h-screen bg-[var(--canvas)]">
      ...
      <main className="mx-auto max-w-5xl px-6 pb-20 sm:px-10">
        <section className="mb-14 pt-8">
          ...
          <h1 className="font-[Georgia,serif] text-4xl font-normal tracking-[-0.03em] text-[var(--burgundy)] sm:text-5xl">
            Hello, <em className="text-[var(--taupe)]">{firstName}.</em>
          </h1>
          <p className="mt-4 max-w-lg text-sm leading-relaxed text-[var(--muted-ink)]">
        ...
        <section>
          <div className="mb-6 flex items-center justify-between border-b border-[var(--line)] pb-4">
            <h2 className="font-[Georgia,serif] text-lg text-[var(--ink)]">
              Getting started
            </h2>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {steps.map((step) => (
              <div
                key={step.number}
                className={`group relative border bg-[var(--paper)] p-6 transition-all ${
                  step.status === "ready"
        ...
        <section className="mt-16 border border-[var(--line)] bg-[var(--paper)] p-8">
          <div className="flex items-start gap-4">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[var(--burgundy)]/10">
              <Camera size={18} className="text-[var(--burgundy)]" />
            </div>
            <div>
              <h3 className="mb-1 font-[Georgia,serif] text-base text-[var(--ink)]">
                Ready to begin?
              </h3>
              ...
              <button className="inline-flex items-center gap-2 bg-[var(--burgundy)] px-5 py-3 text-xs font-medium uppercase tracking-[0.08em] text-[#fff9f7] shadow-[0_1rem_2rem_rgba(85,19,27,0.12)] transition-all hover:bg-[#3c0b12] hover:shadow-[0_1.2rem_2.4rem_rgba(85,19,27,0.2)] hover:-translate-y-0.5">
                Upload selfie
